...
with tab_demo:
    ...
    st.markdown("Загрузите файл `.wav`, чтобы определить — это **настоящий** голос человека "
                "или **синтетическая / дипфейк** запись.")

    uploaded = st.file_uploader(
        label="Перетащите WAV-файл сюда или нажмите для выбора",
        type=["wav"],
...
временных окнах. Настоящая речь, как правило, даёт более плавные и равномерные активации.
        ...
        st.info("👆 Загрузите файл `.wav` выше, чтобы начать анализ.")
